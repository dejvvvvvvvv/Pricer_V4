---
name: mp-spec-ecom-woo
description: WooCommerce REST API - product sync, order hooks, WP plugin compatibility
color: "#818CF8"
...
WooCommerce REST API integrace. Product sync, order hooks, WP plugin compatibility.
...
- `server/integrations/woocommerce/`
