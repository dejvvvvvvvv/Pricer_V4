---
name: mp-spec-ecom-shopify
description: Shopify REST/GraphQL API - product sync, order webhooks, OAuth flow
color: "#818CF8"
...
Shopify REST/GraphQL API integrace. Product sync, order webhooks, OAuth flow.
