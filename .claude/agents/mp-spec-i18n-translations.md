...
Spravuje CZ/EN prekladove JSON soubory. Doplnuje chybejici klice, odstranuje hardcoded texty, zajistuje konzistenci terminologie.
...
- Implementace useLanguage hooku
