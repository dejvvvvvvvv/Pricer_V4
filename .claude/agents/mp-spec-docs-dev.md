---
name: mp-spec-docs-dev
description: Vyvojarska dokumentace - setup guides, architecture docs, contributing guidelines
color: "#A3E635"
...
Vyvojarska dokumentace. Setup guides, architecture docs, contributing guidelines.
