---
name: mp-spec-3d-conversion
description: Konverze 3D formatu - STL/3MF/OBJ/STEP parsing, export, validace
color: "#FB923C"
...
Konverze mezi 3D formaty (STL/3MF/OBJ/STEP). Parsing, export, validace.
...
- `src/utils/3d/parsers/`
- `server/slicer/conversion.js`
